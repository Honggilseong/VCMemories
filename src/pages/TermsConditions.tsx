  ...
  return (
    <div>
      ...
      <div className="max-w-7xl m-auto">
        ...
        <p>
          Welcome to <b>VCMemories</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>vcmemories.com</b> (together or
          individually “Service”) operated by <b>VCMemories</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>vcmemoriessp@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          VCMemories has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of VCMemories or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of VCMemories and its licensors. Service is protected by
          ...
          without the prior written consent of VCMemories.
        </p>
        <p>
        ...
        <p>
          ...
          to vcmemoriessp@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at vcmemoriessp@gmail.com or via
        ...
        <p>
          ...
          that are not owned or controlled by VCMemories.
        </p>
        <p>
          VCMemories has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          laws of South Korea, which governing law applies to agreement without
        ...
        <p className="mb-10">
          ...
          email: <b>vcmemoriessp@gmail.com</b>.
        </p>
      </div>
    </div>
  );
